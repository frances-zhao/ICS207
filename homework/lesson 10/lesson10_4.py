...
#Program Name: Lesson10_4
#Description: prompt user for two even numbers
#output all the even numbers between the two numbers
#making it robust to check if the numbers inputted are robust or not!
#NOTE: this program is the same as lesson10_3 since i made it robust in the lesson10_3 code
#
#*****************************************************
